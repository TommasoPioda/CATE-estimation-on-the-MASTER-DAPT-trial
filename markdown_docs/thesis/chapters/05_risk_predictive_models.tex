...
The same pattern appears in the AUPRC lift, where the rarer endpoints show
...
ranking is dominated by variables that also appear among the trial's
high-bleeding-risk eligibility criteria.}
...
arm, so that their difference estimates the effect of the treatment. Two
...
allow. Chapter 6 shows that four of the five effect estimators recover exactly
these magnitudes. That agreement is the positive control that makes the negative
